(function(){const e=document.getElementById("webmentions-container");if(!e)return;const n=e.getAttribute("data-targets").split(",");if(!n.length)return;const i="https://webmention.io/api/mentions.jf2",s=new URLSearchParams({"sort-by":"published","sort-dir":"up",per_page:"100"});n.forEach(e=>s.append("target[]",e));const a=async()=>{try{e.innerHTML="<p>Loading interactions...</p>";const t=await fetch(`${i}?${s.toString()}`);if(!t.ok)throw new Error("Failed to load webmentions");const n=await t.json();r(n.children||[])}catch(t){e.innerHTML="<p>Could not load interaction data.</p>",console.error(t)}},r=n=>{if(n.length===0){e.innerHTML="<p></p>";return}let s='<ul class="webmentions-list">';n.forEach(e=>{const i=t(e.author?.name||"Unknown"),r=e.author?.photo||"",l=e.author?.url||"",u=e.published?new Date(e.published).toLocaleDateString():"",d=e.content?.html||e.content?.text||"",n=e["wm-property"];let o="mentioned",a="💬";n==="like-of"&&(o="liked",a="❤️"),n==="repost-of"&&(o="reposted",a="🔁"),n==="in-reply-to"&&(o="replied",a="↩️"),s+=`
